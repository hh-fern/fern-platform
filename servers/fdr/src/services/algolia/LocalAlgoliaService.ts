...
export class LocalAlgoliaServiceImpl implements AlgoliaService {
    ...
    async generateSearchRecords(params: { url: string; docsDefinition: DocsV1Db.DocsDefinitionDb; apiDefinitionsById: Record<string, APIV1Db.DbApiDefinition>; configSegmentTuples: ConfigSegmentTuple[]; }): Promise<AlgoliaSearchRecord[]> {
        return [];
    }
