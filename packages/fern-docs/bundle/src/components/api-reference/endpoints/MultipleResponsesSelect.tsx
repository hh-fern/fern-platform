...
export declare namespace ResponseSelect {
  export interface Props {
    selectedResponse: ApiDefinition.HttpResponse;
    responses: ApiDefinition.HttpResponse[];
    setSelectedResponse: (response: ApiDefinition.HttpResponse) => void;
    getResponseId: (response: ApiDefinition.HttpResponse) => ReactNode;
  }
}

export const ResponseSelect: FC<
  PropsWithChildren<ResponseSelect.Props>
> = ({
  selectedResponse,
  responses,
  setSelectedResponse,
