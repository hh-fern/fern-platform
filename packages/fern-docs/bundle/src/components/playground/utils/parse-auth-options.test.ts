...
describe("parseAuthOptions", () => {
  ...
  it("should parse token for pre-selected value", () => {
    const token =
      "[{'application 1': 123, 'selected': false}, {'application 2': 456, 'selected': true}]";
    const result = parseAuthOptions(token);
  ...
  it("should handle tokens with different value types", () => {
    const token =
      "[{'string_key': 'string_value'}, {'number_key': 42}, {'bool_key': true}]";
    const result = parseAuthOptions(token);
  ...
  it("should handle tokens with special characters in keys and values", () => {
    const token =
      "[{'app-name': 'app_value'}, {'app_name': 'app-value'}, {'app.name': 'app.value'}]";
    const result = parseAuthOptions(token);
...
describe("returnSelectedOption", () => {
  it("should return the explicitly selected option", () => {
    const token =
      "[{'app1': 123, 'selected': false}, {'app2': 456, 'selected': true}]";
  ...
  it("should return the first option when all selected properties are false", () => {
    const token =
      "[{'app1': 123, 'selected': false}, {'app2': 456, 'selected': false}]";
    const result = returnSelectedOption(token);
  ...
  it("should handle tokens with spaces around colons", () => {
    const token =
      "[{'app1': 123}, {'app2' : 456, 'selected': true}, {'app3': 789}]";
    const result = returnSelectedOption(token);
  ...
  it("should handle mixed value types", () => {
    const token =
      "[{'app1': 'string_value'}, {'app2': 42, 'selected': true}, {'app3': true}]";
    const result = returnSelectedOption(token);
...
describe("convertAuthOptionsToToken", () => {
  ...
  it("should handle options with special characters in keys and values", () => {
    ...
    expect(result).toBe(
      "[{app-name: app_value, 'selected': true}, {app.name: app.value, 'selected': false}]"
    );
  });
  ...
  it("should handle options with quoted values", () => {
    ...
    expect(result).toBe(
      "[{string_key: string_value, 'selected': true}, {number_key: 42, 'selected': false}]"
    );
  });
  ...
  it("should handle options with boolean values", () => {
    ...
    expect(result).toBe(
      "[{bool_key: true, 'selected': true}, {another_bool: false, 'selected': false}]"
    );
  });
  ...
  it("should handle options with unicode characters", () => {
    ...
    expect(result).toBe(
      "[{café: résumé, 'selected': true}, {über: naïve, 'selected': false}]"
    );
  });
