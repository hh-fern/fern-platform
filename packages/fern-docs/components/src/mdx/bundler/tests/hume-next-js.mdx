    ...
    **App Router** in Next.js and is broken down into four key components:
    ...
    <Steps>
      ...
      <CodeBlock title="React">
        ```tsx
        // ./app/page.tsx
        import ClientComponent from "@fern-docs/components/ClientComponent";
    ...
    <Steps>
      ...
      <Callout intent='info'>
        ...
        <CodeBlock title="React">
          ```tsx
          // ./pages/index.tsx
          import Controls from "@fern-docs/components/Controls";
          import Messages from "@fern-docs/components/Messages";
          import { fetchAccessToken } from "hume";
          import { VoiceProvider } from "@humeai/voice-react";
