    ...
    return (
        <SonnerToaster
            ...
            toastOptions={{
                unstyled: true,
                classNames: {
                    toast: "rounded-2 border border-border-default bg-background w-full flex items-start p-2 pl-3 shadow-xl",
            ...
            icons={{
                success: <CheckCircle className="size-icon text-(color:--grayscale-a11)" />,
                info: <Info className="size-icon text-(color:--grayscale-a11)" />,
                warning: <AlertCircle className="size-icon text-(color:--grayscale-a11)" />,
                error: <XCircle className="size-icon text-(color:--grayscale-a11)" />,
                loading: <Loader2 className="size-icon text-(color:--grayscale-a11) animate-spin" />
            }}
        />
    );
};
