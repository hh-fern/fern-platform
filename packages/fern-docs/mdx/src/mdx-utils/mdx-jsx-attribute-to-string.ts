...
export function mdxJsxAttributeToString(attribute: MdxJsxAttribute): string | undefined {
    if (typeof attribute.value === "string") {
        return attribute.value;
    }

    if (typeof attribute.value === "object" && attribute.value?.type === "mdxJsxAttributeValueExpression") {
