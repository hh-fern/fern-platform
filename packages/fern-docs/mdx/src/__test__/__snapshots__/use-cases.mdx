...
> 👍 You can find more code samples in the [EdgeWorkers GitHub repository](https://github.com/akamai/edgeworkers-examples/tree/master/edgecompute/examples). They are practical examples to use as a starting point for your \{\{COMPANY\_NICKNAME}}. Feel free to use, modify, and extend!
...
4. Create a `bundle.json` file that contains metadata for the EdgeWorkers function.
