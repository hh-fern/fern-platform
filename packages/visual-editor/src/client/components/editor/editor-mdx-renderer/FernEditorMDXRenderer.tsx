...
import { EditorComponentChildrenProvider } from "@/client/components/editor/editor-component/EditorComponentChildrenContext";
import { EditorComponentProvider } from "@/client/components/editor/editor-component/EditorComponentContext";
import { Skeleton } from "@/client/components/ui/skeleton";
import { ErrorBoundary } from "@/client/docs/components/error-boundary";
import { useDebounce } from "@/client/hooks/useDebounce";
import { cachedBundleMDX } from "@/server/cache";
...
const TerminalMDXRenderer = React.memo(({ code, components }: TerminalMDXRendererProps) => {
    const MDXComponent = useMemo(() => {
        try {
            ...
            // biome-ignore lint/suspicious/noConsole: allow console.warn for now
