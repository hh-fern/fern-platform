 ...
 * Note: CloudArrowUpIcon needs to be provided by parent package
 */
            ...
            <div className="tiptap-image-upload-preview-content">
                <div className="tiptap-image-upload-file-info">
                    <div className="tiptap-image-upload-file-icon">
                        {/* Cloud upload icon placeholder - should be provided by consumer */}
...
export interface MediaUploadNodeComponentProps extends NodeViewProps {
    // Additional UI components that need to be provided
    Button?: React.ComponentType<any>;
    Input?: React.ComponentType<any>;
    Popover?: React.ComponentType<any>;
    PopoverContent?: React.ComponentType<any>;
    PopoverTrigger?: React.ComponentType<any>;
    TabGroup?: React.ComponentType<any>;
    Tab?: React.ComponentType<any>;
}

export const MediaUploadNode: React.FC<MediaUploadNodeComponentProps> = (props) => {
    const { accept, limit, maxSize } = props.node.attrs;
    const inputRef = React.useRef<HTMLInputElement>(null);
    const extension = props.extension;
    const [imageUrl, setImageUrl] = React.useState("");

    // Extract UI components from props
    const { Button, Input, Popover, PopoverContent, PopoverTrigger, TabGroup, Tab } = props;
    ...
    // Render simplified version if UI components not provided
    if (!Button || !Input || !Popover || !PopoverContent || !PopoverTrigger || !TabGroup || !Tab) {
        return (
