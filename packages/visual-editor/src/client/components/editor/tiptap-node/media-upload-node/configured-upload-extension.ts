...
import { useVisualEditorApiClient, type VisualEditorApiClient } from "@/client/providers/VisualEditorApiClientContext";
import { parseDocsUrlParam } from "@/shared/parseDocsUrlParam";
...
const private_handleMediaUpload = async ({
    ...
    const response = await client.generateSignedUploadUrl({
        fileName: file.name,
