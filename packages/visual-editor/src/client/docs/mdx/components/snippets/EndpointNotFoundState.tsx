...
import { EditorComponentPopoverButton } from "@/client/components/editor/editor-component/EditorComponentPopover";
...
export function EndpointNotFoundState({ endpointProp, snippetRef }: EndpointNotFoundStateProps) {
        ...
        return (
            <div ref={snippetRef} className="relative">
                <div className="bg-card-background border-card-border rounded-3 shadow-card-grayscale relative flex flex-col overflow-hidden border">
                    {isWithinEditor && <EditorComponentPopoverButton className="absolute right-2 top-2 z-10" />}
                    <div className="flex items-start gap-3 p-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <code className="rounded bg-gray-100 px-1 py-0.5 dark:bg-gray-800">GET /users</code>)
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div ref={snippetRef} className="relative">
            <div className="bg-card-background border-card-border rounded-3 shadow-card-grayscale relative flex flex-col overflow-hidden border">
                ...
                <div className="flex items-start gap-3 p-4">
                    ...
                    <div className="flex-1">
                        <div className="text-sm font-medium text-red-900 dark:text-red-100">Endpoint not found</div>
                        <div className="mt-1 text-sm text-red-700 dark:text-red-300">
                            The endpoint{" "}
                            <code className="rounded bg-red-100 px-1 py-0.5 dark:bg-red-900/50">{endpointProp}</code>{" "}
