...
export default async function getPrForBranch(request: GetPrForBranchRequest): Promise<GetPrForBranchResponse> {
 ...
 */
async function getPrForBranchCached(request: GetPrForBranchRequest): Promise<GetPrForBranchResponse> {
    "use cache";
