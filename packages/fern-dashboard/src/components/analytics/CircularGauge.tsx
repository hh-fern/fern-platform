...
export default function CircularGauge({ percentage, size = 100, strokeWidth = 20 }: CircularGaugeProps) {
    ...
    return (
        ...
        >
            ...
            <span className="text-radix-gray-9 absolute text-base font-semibold">{percentage}%</span>
        </div>
    );
}
