...
export function DocsSiteStatusIndicator({ docsUrl }: DocsSiteStatusIndicatorProps) {
  ...
  return (
    <div className={`flex shrink-0 items-center gap-2 rounded-full px-3 py-2 ${bgColor}`}>
