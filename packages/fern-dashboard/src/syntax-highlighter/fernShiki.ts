...
export const getHighlighterInstance = () => memoizedGetHighlighterInstance;
...
export function highlightTokens(highlighter: Highlighter, code: string, lang: string): HighlightedTokens {
    code = trimCode(code);
    lang = parseLang(lang);
